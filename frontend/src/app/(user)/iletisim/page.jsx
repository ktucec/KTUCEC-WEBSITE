                    ...
                    <div className="md:col-span-5 flex flex-col gap-8">
                        ...
                        <div className="grid grid-cols-4 gap-3 mx-auto md:hidden">
                            ...
                            <a
                                ...
                                className="fade-up aspect-square bg-white text-[#EA4335] border border-gray-100 rounded-2xl p-2 flex items-center justify-center shadow-sm hover:bg-[#EA4335] hover:text-white active:bg-[#C5221F] active:scale-95 hover:-translate-y-1 transition-all duration-300 ease-in-out group"
                            >
                                <span className="material-symbols-outlined text-[42px] group-hover:scale-110 transition-transform duration-300">
                                    mail
                                </span>
                            </a>
                            ...
                            <a
                                ...
                                className="fade-up aspect-square bg-white text-[#25D366] border border-gray-100 rounded-2xl p-2 flex items-center justify-center shadow-sm hover:bg-[#25D366] hover:text-white active:bg-[#128C7E] active:scale-95 hover:-translate-y-1 transition-all duration-300 ease-in-out group"
                            >
                            ...
                            <a
                                ...
                                className="fade-up aspect-square bg-white text-[#E4405F] border border-gray-100 rounded-2xl p-2 flex items-center justify-center shadow-sm hover:bg-[#E4405F] hover:text-white active:scale-95 hover:-translate-y-1 transition-all duration-300 ease-in-out group"
                            >
                                <svg className="w-11 h-11 fill-current group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
